...
import com.future.database.api.anno.EnableProDataAccess;
...
public class ProMapperScannerRegistrar implements ImportBeanDefinitionRegistrar {

    private static final int IDX = 0;

    @Override
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        AnnotationAttributes mapperScanAttrs = fromMap(importingClassMetadata.getAnnotationAttributes(EnableProDataAccess.class.getName()));
