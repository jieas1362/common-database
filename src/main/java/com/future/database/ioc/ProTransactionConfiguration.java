...
import com.future.database.api.conf.TransConf;
...
public class ProTransactionConfiguration {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProTransactionConfiguration.class);
    ...
    TransactionInterceptor txAdvice(TransactionManager txManager, TransConf transConf) {
        ...
        attributeWithTrans.setRollbackRules(singletonList(new RollbackRuleAttribute(Throwable.class)));
